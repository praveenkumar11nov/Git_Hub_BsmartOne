...
<div class="deep-purple-700 bg-big">
  <div class="text-center">
    <h1 class="text-shadow no-margin text-white text-4x p-v-lg">
      <span class="text-2x font-bold m-t-lg block">500</span>
    </h1>
    <h2 class="h1 m-v-lg">Oops!  Something went wrong.</h2>
    <p class="h4 m-v-lg text-u-c font-bold">We are fixing it, Please come back in a while.</p>
    <div class="p-v-lg">
