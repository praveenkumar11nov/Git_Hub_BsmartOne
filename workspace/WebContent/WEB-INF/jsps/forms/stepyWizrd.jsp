<%@include file="/WEB-INF/decorators/taglibs.jsp"%>
   <script type="text/javascript" src="resources/${themeLayout}/assets/js/plugins/forms/wizards/stepy.min.js"></script>
	...
	<script type="text/javascript" src="resources/${themeLayout}/assets/js/pages/wizard_stepy.js"></script>
...
function finalSubmit() {
	  ...
	  swal({
          ...
          confirmButtonColor: "#2196F3"
		            ...
		            <div class="panel panel-white">
						<div class="panel-heading">
							<h6 class="panel-title">Clickable title</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
		            ...
		            <div class="panel panel-white">
						<div class="panel-heading">
							<h6 class="panel-title">Hide step description</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
	                	...
	                	<form class="stepy-no-description" action="#">
							<fieldset title="1">
								<legend class="text-semibold">Personal data</legend>
		            ...
		            <div class="panel panel-white">
						<div class="panel-heading">
							<h6 class="panel-title">Stepy callbacks</h6>
							<div class="heading-elements">
								<ul class="icons-list">
			                		<li><a data-action="collapse"></a></li>
			                		<li><a data-action="reload"></a></li>
